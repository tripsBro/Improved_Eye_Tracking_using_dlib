...
##==========start the video==================
cap = cv2.VideoCapture('/home/rahul/Videos/new/rahul-8-10-2017_1000.h264')

##==============create objects for the detectors and predictors================
detector = dlib.simple_object_detector("/home/rahul/cv/xml files/pupil.svm")
predictor = dlib.shape_predictor("/home/rahul/cv/xml files/pupilPredictor.dat")
Goteye = dlib.simple_object_detector("/home/rahul/cv/xml files/GotEye.svm")
